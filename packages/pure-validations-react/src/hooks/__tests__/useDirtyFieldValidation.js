...
import { isValid, Validator, Validation, validate, __clearMocks } from '@totalsoft/pure-validations'
...
describe("UseDirtyFieldValidaiton hook", () => {
    ...
    it("changes the validation function when the validator changes", () => {
        // Arrange
        const callback = () => useDirtyFieldValidation(Validator.of(Validation.Success()))
